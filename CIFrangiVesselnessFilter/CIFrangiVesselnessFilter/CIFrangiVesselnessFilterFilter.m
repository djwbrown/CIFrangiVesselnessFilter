//
//  CIFrangiVesselnessFilterFilter.m
...
#import "CIFrangiVesselnessFilterFilter.h"
#import <Foundation/Foundation.h>
#import <ApplicationServices/ApplicationServices.h>

@implementation CIFrangiVesselnessFilterFilter

static CIKernel *_CIFrangiVesselnessFilterFilterKernel = nil;

- (instancetype)init
{
    if(!_CIFrangiVesselnessFilterFilterKernel) {
		NSBundle    *bundle = [NSBundle bundleForClass:NSClassFromString(@"CIFrangiVesselnessFilterFilter")];
		NSStringEncoding encoding = NSUTF8StringEncoding;
		NSError     *error = nil;
		NSString    *code = [NSString stringWithContentsOfFile:[bundle pathForResource:@"CIFrangiVesselnessFilterFilterKernel" ofType:@"cikernel"] encoding:encoding error:&error];
		NSArray     *kernels = [CIKernel kernelsWithString:code];

		_CIFrangiVesselnessFilterFilterKernel = kernels[0];
    }
    return [super init];
}
...
- (CIImage *)outputImage
{
    ...
    return [self apply:_CIFrangiVesselnessFilterFilterKernel, src,
